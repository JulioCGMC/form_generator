...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({Key? key, required this.value, this.onChanged, this.decoration, this.obscureText = false}) : super(key: key);

  @override
  _CustomTextFieldState createState() => _CustomTextFieldState(this.obscureText);
}
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: widget.decoration?.copyWith(
        suffixIcon: widget.obscureText ? _obscureIcon() : null
      ),
      keyboardType: widget.value.fieldType == FieldType.number 
            ? TextInputType.number : widget.value.fieldType == FieldType.email 
